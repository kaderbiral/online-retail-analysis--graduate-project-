...
<body>
  ...
  <div class="area">
      ...
      <div class="col-lg-3">
        ...
        <div class="card card-stats">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col">
                <h5 class="card-title font-weight-bold mb-2">Satış</h5>
                <span class="h3  mb-0">$877 M</span>
              </div>
              <div class="col-auto">
                <div class="icon">
            ...
            <p class="mt-2 mb-0 text-sm" id="text">
              <span class="text-secondary mr-2"><i class="fa fa-arrow-right"></i> <a href="satis.php" style="color: gray" target="blank">Daha Fazla</a></span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3">
        <div class="card card-stats">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col">
                <h5 class="card-title font-weight-bold mb-2">Kâr Tutarı</h5>
                <span class="h3 mb-0">$849 M</span>
              </div>
              <div class="col-auto">
                <div class="icon">
            ...
            <p class="mt-2 mb-0 text-sm" id="text">
              <span class="text-secondary mr-2"><i class="fa fa-arrow-right"></i> <a href="kar_tutari.php" style="color: gray" target="blank">Daha Fazla</a></span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3">
        <div class="card card-stats">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col">
                <h5 class="card-title font-weight-bold mb-2">Maliyet</h5>
                <span class="h3 mb-0">$28 M</span>
              </div>
              <div class="col-auto">
                <div class="icon">
            ...
            <p class="mt-2 mb-0 text-sm" id="text"> 
              <span class="text-secondary mr-2"><i class="fa fa-arrow-right"></i> <a href="maliyet.php" style="color: gray" target="blank">Daha Fazla</a></span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3">
        <div class="card card-stats">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col">
                <h5 class="card-title font-weight-bold mb-2">Satılan Ürün Sayısı</h5>
                <span class="h3 mb-0">5510</span>
              </div>
              <div class="col-auto">
                <div class="icon">
            ...
            <p class="mt-2 mb-0 text-sm">
              <span class="text-secondary mr-2" id="text"><i class="fa fa-arrow-right"></i> <a href="satislar.php" style="color: gray" target="blank">Daha Fazla</a></span>
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="satis-1">
        ...
        <div class='tableauPlaceholder' id='viz1589665902211' style='position: relative'><noscript><a href='#'><img alt=' ' src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;An&#47;Anasayfa-Satislar&#47;Satislar&#47;1_rss.png' style='border: none' /></a></noscript><object class='tableauViz'  style='display:none;'><param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' /> <param name='embed_code_version' value='3' /> <param name='site_root' value='' /><param name='name' value='Anasayfa-Satislar&#47;Satislar' /><param name='tabs' value='no' /><param name='toolbar' value='yes' /><param name='static_image' value='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;An&#47;Anasayfa-Satislar&#47;Satislar&#47;1.png' /> <param name='animate_transition' value='yes' /><param name='display_static_image' value='yes' /><param name='display_spinner' value='yes' /><param name='display_overlay' value='yes' /><param name='display_count' value='yes' /></object></div>                <script type='text/javascript'>                    var divElement = document.getElementById('viz1589665902211');                    var vizElement = divElement.getElementsByTagName('object')[0];                    if ( divElement.offsetWidth > 800 ) { vizElement.style.minWidth='420px';vizElement.style.maxWidth='1238px';vizElement.style.width='100%';vizElement.style.height='527px';} else if ( divElement.offsetWidth > 500 ) { vizElement.style.minWidth='420px';vizElement.style.maxWidth='1238px';vizElement.style.width='100%';vizElement.style.height='527px';} else { vizElement.style.width='100%';vizElement.style.height='1677px';}                     var scriptElement = document.createElement('script');                    scriptElement.src = 'https://public.tableau.com/javascripts/api/viz_v1.js';                    vizElement.parentNode.insertBefore(scriptElement, vizElement);                </script>
